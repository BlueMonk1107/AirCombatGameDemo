...
public class StrengthenController : ControllerBase {
    ...
    private void Upgrades()
    {
        ...
        key = KeysUtil.GetPropertyKeys(DataKeys.UPGRADES + GameStateModel.Single.Level);
        ...
        if (money >= cost && GameStateModel.Single.Level < levelMax)
        {
    ...
    private void ChangeLevel()
    {
        ...
        int level = GameStateModel.Single.Level;
        level++;
